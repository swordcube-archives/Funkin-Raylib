...
import engine.tweens.misc.NumTween;
import engine.tweens.misc.VarTween;
import engine.tweens.motion.CircularMotion;
import engine.tweens.motion.CubicMotion;
import engine.tweens.motion.LinearMotion;
import engine.tweens.motion.LinearPath;
import engine.tweens.motion.QuadMotion;
...
/**
 * `FlxTween` but ported to this shitty raylib engine.
 * @see https://github.com/HaxeFlixel/flixel/blob/master/flixel/tweens/FlxTween.hx
 */
class Tween implements IDestroyable {
	/**
	 * Deprecated, use `TweenType.PERSIST` instead.
	 */
	@:deprecated("Use TweenType.PERSIST instead")
	public static var PERSIST = TweenType.PERSIST;

	/**
	 * Deprecated, use `TweenType.LOOPING` instead.
	 */
	@:deprecated("Use TweenType.LOOPING instead")
	public static var LOOPING = TweenType.LOOPING;

	/**
	 * Deprecated, use `TweenType.PINGPONG` instead.
	 */
	@:deprecated("Use TweenType.PINGPONG instead")
	public static var PINGPONG = TweenType.PINGPONG;

	/**
	 * Deprecated, use `TweenType.ONESHOT` instead.
	 */
	@:deprecated("Use TweenType.ONESHOT instead")
	public static var ONESHOT = TweenType.ONESHOT;

	/**
	 * Deprecated, use `TweenType.BACKWARD` instead.
	 */
	@:deprecated("Use TweenType.BACKWARD instead")
	public static var BACKWARD = TweenType.BACKWARD;
	 ...
	 */
	public static function color(?Sprite:Sprite, Duration:Float = 1, FromColor:Color, ToColor:Color, ?Options:TweenOptions):ColorTween {
	 ...
	 */
	public static function linearMotion(Object:Object, FromX:Float, FromY:Float, ToX:Float, ToY:Float, DurationOrSpeed:Float = 1, UseDuration:Bool = true,
	 ...
	 */
	public static function quadMotion(Object:Object, FromX:Float, FromY:Float, ControlX:Float, ControlY:Float, ToX:Float, ToY:Float,
	 ...
	 */
	public static function cubicMotion(Object:Object, FromX:Float, FromY:Float, aX:Float, aY:Float, bX:Float, bY:Float, ToX:Float, ToY:Float,
	 ...
	 */
	public static function circularMotion(Object:Object, CenterX:Float, CenterY:Float, Radius:Float, Angle:Float, Clockwise:Bool,
	 ...
	 */
	public static function linearPath(Object:Object, Points:Array<Point2D>, DurationOrSpeed:Float = 1, UseDuration:Bool = true,
	 ...
	 */
	public static function quadPath(Object:Object, Points:Array<Point2D>, DurationOrSpeed:Float = 1, UseDuration:Bool = true,
...
class TweenManager extends Basic {
	...
	public function new():Void {
		super();
		Game.signals.preSceneCreate.add(clear);
	}
	 ...
	 * @return	The added ColorTween object.
	 */
	public function color(?Sprite:Sprite, Duration:Float = 1, FromColor:Color, ToColor:Color, ?Options:TweenOptions):ColorTween {
	 ...
	 * @return The LinearMotion object.
	 */
	public function linearMotion(Object:Object, FromX:Float, FromY:Float, ToX:Float, ToY:Float, DurationOrSpeed:Float = 1, UseDuration:Bool = true,
			?Options:TweenOptions):LinearMotion {
	 ...
	 * @return The QuadMotion object.
	 */
	public function quadMotion(Object:Object, FromX:Float, FromY:Float, ControlX:Float, ControlY:Float, ToX:Float, ToY:Float, DurationOrSpeed:Float = 1,
	 ...
	 * @return The CubicMotion object.
	 */
	public function cubicMotion(Object:Object, FromX:Float, FromY:Float, aX:Float, aY:Float, bX:Float, bY:Float, ToX:Float, ToY:Float, Duration:Float = 1,
	 ...
	 * @return The CircularMotion object.
	 */
	public function circularMotion(Object:Object, CenterX:Float, CenterY:Float, Radius:Float, Angle:Float, Clockwise:Bool, DurationOrSpeed:Float = 1,
	 ...
	 * @return	The LinearPath object.
	 */
	public function linearPath(Object:Object, Points:Array<Point2D>, DurationOrSpeed:Float = 1, UseDuration:Bool = true,
			?Options:TweenOptions):LinearPath {
	 ...
	 * @return	The QuadPath object.
	 */
	public function quadPath(Object:Object, Points:Array<Point2D>, DurationOrSpeed:Float = 1, UseDuration:Bool = true, ?Options:TweenOptions):QuadPath {
	...
	override public function destroy():Void {
		super.destroy();
		Game.signals.preSceneCreate.remove(clear);
	}
